"""models/bs_roformer/bs_roformer_hyperace2.py
------------------------------------------------
pcunwa BS-Roformer-HyperACE v2 (SegmModel mask estimator with k=2 high-order
branches and TDF upsample head). Configs mark this variant with top-level
``hyperace2: true``. Vendored from pcunwa/BS-Roformer-HyperACE
