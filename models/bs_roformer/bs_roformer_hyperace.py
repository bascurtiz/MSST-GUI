"""models/bs_roformer/bs_roformer_hyperace.py
------------------------------------------------
pcunwa BS-Roformer-HyperACE v1 (SegmModel mask estimator with k=3 high-order
branches). Configs mark this variant with top-level ``hyperace: true``.
Vendored from pcunwa/BS-Roformer-HyperACE (main/bs_roformer.py).
"""
