...
REQUIRED_MODELS = [
    ...
    IterativeModel(
        ...
        arch="BS Roformer Architecture",
        stem_type="vocals",
        ckpt_url="https://huggingface.co/jarredou/unwa_bs_roformer/resolve/main/BS-Roformer_LargeV1.ckpt?download=true",
        yaml_url="https://huggingface.co/jarredou/unwa_bs_roformer/resolve/main/config_bsrofoL.yaml?download=true",
